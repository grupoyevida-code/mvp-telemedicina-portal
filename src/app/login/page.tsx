...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simular login - em produção, conectar com API
    setTimeout(() => {
        ...
        <Card className="border-blue-100 shadow-2xl">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-gray-600">
              Entre na sua conta para acessar seus serviços de saúde
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-white px-2 text-sm text-gray-500">ou continue com</span>
              </div>
            </div>
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <p className="text-sm font-medium text-blue-800 mb-2">Demo - Usuários de teste:</p>
